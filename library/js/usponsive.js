...
function showAdminData() {
  ...
  if (
    getQueryString("showAdminData") == 1 &&
    getQueryString("report") == "responsive"
  ) {
    //Set defaults for admin messages report string
    adminMessages.unshift(
      "<strong>Admin Data (Client) - Responsive Report:</strong><br /><small># - Task, ! - Status, ? - Case</small><br /><br />"
    );
...
function getViewSize() {
  ...
  addAdminMsg(
    "task",
    "getViewSize",
    "viewSize (page view size) size is: <strong>" + viewSize + "</strong>"
  );
...
function adjustScreenSizeTimeout(startViewSize) {
  ...
  if (startViewSize > viewSize) {
    ...
    addAdminMsg(
      "task",
      "adjustScreenSizeTimeout",
      "<strong>Adjust Screen Size Timeout</strong> has been activated."
    );
  }
}
...
DOMContentLoaded(function () {
  ...
  if (pageViewMode == "fullSize") {
    ...
    // Initialize breakpoint state so the FIRST resize can detect a cross
    gxPrevIsUnder640 = viewSize < 640;
...
function gxFullSize() {
  ...
  var footerRegionThree = document.getElementById("footer-region-three");
  if (footerRegionThree) {
    footerRegionThree.style.display = "block";
  }
...
function checkActivePageRegions() {
  ...
  if (document.getElementById("navrow") != null) {
    regionNavrow = "active";
  }
  if (document.getElementById("site-navigation") != null) {
    regionSiteNavigation = "active";
  }
  if (document.getElementById("metarow") != null) {
    regionMetarow = "active";
  }
  if (document.getElementById("leftcol") != null) {
    regionLeftcol = "active";
  }
  if (document.getElementById("rightcol") != null) {
    regionRightcol = "active";
  }
  if (document.getElementById("metafooter") != null) {
    regionMetafooter = "active";
  }
  if (document.getElementById("footer") != null) {
    regionFooter = "active";
  }
  if (document.getElementById("header-region-one") != null) {
    regionHeaderOne = "active";
  }
  if (document.getElementById("header-region-two") != null) {
    regionHeaderTwo = "active";
  }
  if (document.getElementById("header-region-three") != null) {
    regionHeaderThree = "active";
  }
  ...
  if (document.getElementById("column-one") != null) {
    columnone = "active";
  }
  if (document.getElementById("column-two") != null) {
    columntwo = "active";
  }
  if (document.getElementById("column-three") != null) {
    columnthree = "active";
  }

  if (document.getElementById("footer-region-one") != null) {
    regionFooterOne = "active";
  }
  if (document.getElementById("footer-region-two") != null) {
    regionFooterTwo = "active";
  }
  if (document.getElementById("footer-region-three") != null) {
    regionFooterThree = "active";
  }
  if (document.getElementById("subfooter") != null) {
    regionSubfooter = "active";
  }
...
function setLayoutSize(viewSize) {
  if (viewSize < 320) {
    layoutSize = "xx-small";
  } else if (viewSize >= 320 && viewSize < 480) {
    layoutSize = "x-small";
  } else if (viewSize >= 480 && viewSize < 640) {
    layoutSize = "small";
  } else if (viewSize >= 640 && viewSize < 768) {
    layoutSize = "medium";
  } else if (viewSize >= 768 && viewSize < 960) {
    layoutSize = "large";
  } else if (viewSize >= 960 && viewSize < 1280) {
    layoutSize = "x-large";
  } else if (viewSize >= 1280) {
    layoutSize = "xx-large";
  }
  ...
  addAdminMsg(
    "task",
    "setLayoutSize",
    "Response layout size set to: <strong>" + layoutSize + "</strong>"
  );
...
function adjustResponsiveCSS(viewSize, layoutSize) {
  ...
  addAdminMsg(
    "status",
    "adjustResponsiveCSS",
    "adjustMinMax640(), adjustRightCol(), adjustResponseLayout()"
  );
  ...
  addAdminMsg(
    "case",
    "minMax640",
    "minMax640 layout size set to: <strong>" + minMax640 + "</strong>"
  );
  ...
  addAdminMsg(
    "task",
    "adjustResponsiveCSS",
    "Responsive CSS adjustments made."
  );
}
...
function adjustRightCol(minMax) {
  if (minMax == "max") {
    ...
    addAdminMsg(
      "case",
      "adjustRightCol",
      "Adjustments for <strong>right column UNDER 640</strong> activated."
    );
  }
  ...
  addAdminMsg(
    "task",
    "adjustRightCol",
    "<strong>Min Max 640</strong> right column adjustments made."
  );
}
...
function adjustMinMax640(minMax640) {
  ...
  addAdminMsg(
    "task",
    "adjustMinMax640",
    "<strong>Min Max 640</strong> page layout adjustments made."
  );
}
...
function adjustResponseLayout(layoutSize) {
  ...
  addAdminMsg(
    "task",
    "adjustResponseLayout",
    "Specific responsive adjustments made for layout size <strong>" +
      layoutSize +
      "</strong>"
  );
}
...
function setMin640() {
  ...
  addAdminMsg(
    "case",
    "adjustMinMax640",
    "<strong>Min 640</strong> page view adjustments made."
  );
}
...
function setMax640() {
  ...
  addAdminMsg(
    "case",
    "adjustMinMax640",
    "<strong>Max 640</strong> page view adjustments made."
  );
}

// Only used when crossing from <640 to >=640
function gxExpandToMediumPlus() {
  // Undo the key inline styles set by setMax640()
  var pageContent = document.getElementById("page-content");
  if (pageContent) {
    pageContent.style.maxWidth = "";
    // allow normal width rules to apply; setMin640 may set width later if needed
  ...
  if (regionNavrow == "active") {
    ...
    if (navrow) {
      navrow.style.maxWidth = "";
    }

    var collapse = document.getElementById("collapse");
    if (collapse) {
      collapse.style.maxWidth = "";
    }
  ...
  // Clear inline "collapsed" styles that can stick on header/columns
  gxClearInline(document.getElementById("header-region-one"));
  gxClearInline(document.getElementById("header-region-two"));
  gxClearInline(document.getElementById("header-region-three"));

  gxClearInline(document.getElementById("column-one"));
  gxClearInline(document.getElementById("column-two"));
  gxClearInline(document.getElementById("column-three"));

  gxClearInline(document.getElementById("main"));
  gxClearInline(document.getElementById("rightcol"));

  // Topbar can remain in "mobile" inline styles after setMax640()
  gxClearInline(document.getElementById("topbar"));
  gxClearInline(document.getElementById("topbar-content"));

  // Clear inline styles that can keep topbar compressed after expanding to >=640
  gxClearInline(document.getElementById("topbar-left"));
  gxClearInline(document.getElementById("topbar-right"));

  // Clear inline styles that can keep footer compressed after expanding to >=640
  gxClearInline(document.getElementById("metafooter"));
  gxClearInline(document.getElementById("metafooter-content"));

  // Left column can stay "collapsed" due to inline styles from collapseLayoutSingleColumn()
  gxClearInline(document.getElementById("leftcol"));
  gxClearInline(document.getElementById("content"));

  // Clear inner leftcol wrapper(s) (class-based in your HTML)
  gxClearInlineByClass("leftcol", "leftcol-content");

  // Clear primary content area inline styles
  gxClearInline(document.getElementById("primary"));

  // Now re-run your normal responsive pipeline (like page load)
  gxResponsive();
}

// Clear inline styles for a given element
function gxClearInline(el) {
  if (!el) return;
  el.style.width = "";
  el.style.maxWidth = "";
  el.style.minWidth = "";
...
// Clear inline styles for all elements with given class inside parent element
function gxClearInlineByClass(parentId, className) {
  var parent = document.getElementById(parentId);
  if (!parent) return;

  // IE6/7 safe class scan
  var nodes = parent.getElementsByTagName("*");
  for (var i = 0; i < nodes.length; i++) {
    if (nodes[i].className && nodes[i].className.indexOf(className) !== -1) {
      gxClearInline(nodes[i]);
    }
  }
}
...
function adjustLayoutByRegions() {
  ...
  addAdminMsg(
    "task",
    "adjustLayoutByRegions",
    "<strong>Adjust Layout By Regions</strong> page layout adjustments made."
  );
}
...
function collapseLayoutSingleColumn() {
  ...
  addAdminMsg(
    ...
    "<strong>Collapse Layout Single Column</strong> page layout adjustments made."
  );
...
function collapseLayoutDualColumn() {
  ...
  addAdminMsg(
    "task",
    "collapseLayoutDualColumn",
    "<strong>Collapse Layout Dual Column</strong> page layout adjustments made."
  );
...
function setSeeRegionsByColor() {
  ...
  if (regionTopbar == "active") {
    document.getElementById("topbar").style.background = "#036";
  }
  if (regionHeader == "active") {
    document.getElementById("header").style.background = "#090";
  }
  if (regionMetarow == "active") {
    document.getElementById("metarow").style.background = "#0ff";
  }
  if (regionLeftcol == "active") {
    document.getElementById("leftcol").style.background = "#f30";
  }
  if (regionRightcol == "active") {
    document.getElementById("rightcol").style.background = "#fc0";
  }
  if (regionMetafooter == "active") {
    document.getElementById("metafooter").style.background = "#0f9";
  }
  if (regionFooter == "active") {
    document.getElementById("footer").style.background = "#033";
  }
  if (regionHeaderOne == "active") {
    document.getElementById("header-region-one").style.background = "#06f";
  }
  if (regionHeaderTwo == "active") {
    document.getElementById("header-region-two").style.background = "#6f0";
  }
  if (regionHeaderThree == "active") {
    document.getElementById("header-region-three").style.background = "#0cc";
  }
  if (regionFooterOne == "active") {
    document.getElementById("footer-region-one").style.background = "#906";
  }
  if (regionFooterTwo == "active") {
    document.getElementById("footer-region-two").style.background = "#f90";
  }
  if (regionFooterThree == "active") {
    document.getElementById("footer-region-three").style.background = "#336";
  }
  if (regionAside == "active") {
    document.getElementById("aside").style.background = "#02D6F0";
  }
}
...
function fixMinWidthForIE() {
  ...
  for (e = 0; e < elems.length; e++) {
    ...
    if (l_minWidth && l_minWidth != "auto") {
      ...
      shim.style.cssText =
        "margin:0 !important; padding:0 !important; border:0 !important; line-height:0 !important; height:0 !important; BACKGROUND:RED;";
...
function DOMContentLoaded() {
  ...
  function addOnload(fn) {
    ...
    if (typeof addOnload.queue !== "object") {
      // allow loose comparison of arrays
      addOnload.queue = [];
    ...
    window.onload = function () {
      // iterate through the queued functions
      for (var i = 0; i < addOnload.queue.length; i++) {
        addOnload.queue[i]();
      }
    };
  }
  ...
  function detach() {
    ...
    } else if (dev in window) {
      window[dev]("onload", ready);
    } else {
      dequeueOnload(ready);
    }
  }
